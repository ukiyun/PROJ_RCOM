...
// responses
#define C_RR0 0x05		// indication sent by the receiver that it is ready to receive an information frame n� 0
#define C_RR1 0x85		// indication sent by the receiver that it is ready to receive an information frame n� 1
#define C_REJ0 0x01		// indication sent by the receiver that it has rejected an information frame n� 0 (detected an error)
#define C_REJ1 0x81		// indication sent by the receiver that it has rejected an information frame n� 1 (detected an error)
